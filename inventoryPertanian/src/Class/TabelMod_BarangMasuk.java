 ...
 * @author user
 */
public abstract class TabelMod_BarangMasuk extends AbstractTableModel{
   ...
   public Object getValueAt (int rowIndex, int columnIndex) {
       switch(columnIndex){
           ...
           case 1: return list.get(rowIndex).getNo_keluar();
           case 2: return list.get(rowIndex).getTgl_keluar();
           case 3: return list.get(rowIndex).getTotal_keluar();
   ...
   public String getColumnName(int Column){
       switch (Column){
           ...
           case 1: return "No Keluar";
           case 2: return "Tanggal Keluar";
